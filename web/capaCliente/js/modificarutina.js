...
$(document).ready(function () {
    ...
    $mirutina.change(function () {
        ...
        $.each(juegosderutina,function (index,value) {
            var aux=0;
            while(listajuegos[aux].nombre!=value){aux++};//localizamos la posición del objeto que tiene un atributo "nombre"= al buscado
    ...
    function creamirutina() {
        $cargando.toggle("fast");
        envio = {"funcion": "listado", "coleccion": "rutina"};
        $.ajax({
            url: "../capaServer/gestionjuegos.php"
            , async: true
            , type: 'post'
    ...
    $guardarutina.click(function () {
        ...
        if(juegosrutina.length==0){
            ...
            $cargando.toggle("fast");
            envio = {"funcion": "actualizar", "nombre": nombrerutina , "juegos": JSON.stringify(juegosrutina)};
            $.ajax({
                url: "../capaServer/gestionjuegos.php"
                , async: true
                , type: 'post'
